...
5. **Clean-Room Assimilation**: External repositories provide architectural inspiration; always reimplement cleanly without copying code, and document in `.ofk/research/`.
