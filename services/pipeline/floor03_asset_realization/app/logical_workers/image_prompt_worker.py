...
class ImagePromptWorker:
    ...
    @staticmethod
    def _reference_assets(scene: SceneSpecification) -> List[AssetReference]:
        return [
            AssetReference(
    ...
    @staticmethod
    def _conditionings(scene: SceneSpecification) -> List[ConditioningSpec]:
        return [
            ConditioningSpec(
    ...
    def execute(
        ...
        for sc in scenes:
            ...
            reference_assets = self._reference_assets(sc)
            conditionings = self._conditionings(sc)
            visual_plan = VisualPromptPlan(
                ...
                visual_references=list(sc.character_references),
